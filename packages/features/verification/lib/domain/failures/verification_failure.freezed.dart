...
part of 'verification_failure.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is VerificationFailure);
}
...
/// @nodoc
class $VerificationFailureCopyWith<$Res>  {
$VerificationFailureCopyWith(VerificationFailure _, $Res Function(VerificationFailure) __);
}


/// Adds pattern-matching-related methods to [VerificationFailure].
extension VerificationFailurePatterns on VerificationFailure {
...
class InvalidCode implements VerificationFailure {
  const InvalidCode();
...
@override
String toString() {
  return 'VerificationFailure.invalidCode()';
}
...
class ExpiredCode implements VerificationFailure {
  const ExpiredCode();
...
@override
String toString() {
  return 'VerificationFailure.expiredCode()';
}
...
class TooManyAttempts implements VerificationFailure {
...
@override
String toString() {
  return 'VerificationFailure.tooManyAttempts()';
}
...
class ServerError implements VerificationFailure {
  const ServerError();
...
@override
String toString() {
  return 'VerificationFailure.serverError()';
}
